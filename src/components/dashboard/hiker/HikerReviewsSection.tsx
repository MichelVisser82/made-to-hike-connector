...
export function HikerReviewsSection({ userId, onWriteReview, openBookingId, onClearBookingId }: HikerReviewsSectionProps) {
  return (
    <div className="space-y-6">
      ...
      <ReviewsTab isGuide={false} openBookingId={openBookingId} onClearBookingId={onClearBookingId} />
    </div>
  );
}
