import { Mountain, Shield, Euro, Users, Calendar, TrendingUp, Leaf, Award, CheckCircle2, Star, BarChart3, FileText, Heart, MapPin, Clock, Check, ArrowRight, Printer } from "lucide-react";
  ...
  return <div className="min-h-screen bg-cream">
      ...
      <section className="min-h-screen flex flex-col lg:flex-row print:page-break-after">
        ...
        <div className="lg:w-1/2 h-[50vh] lg:h-screen relative overflow-hidden">
          <SmartImage category="hero" tags={["Alps", "mountain", "summit"]} alt="Mountain summit sunrise in the Alps" className="w-full h-full object-cover" priority="high" />
        ...
        <div className="lg:w-1/2 bg-charcoal text-white flex items-center justify-center p-8 lg:p-16">
          <div className="max-w-xl">
            ...
            <h1 className="text-6xl lg:text-7xl text-white mb-6 leading-tight" style={{
            ...
            <div className="grid grid-cols-3 gap-6 mb-12 pb-12 border-b border-white/20">
              <div>
                <div className="text-5xl text-burgundy-light mb-2" style={{
                fontFamily: 'Playfair Display, serif'
              }}>95%</div>
      ...
      <section className="min-h-screen bg-cream py-16 px-8 lg:px-16 flex items-center print:page-break-after">
        <div className="max-w-6xl mx-auto w-full">
          <div className="mb-12">
            ...
            <h2 className="text-4xl lg:text-6xl text-charcoal mb-6" style={{
            fontFamily: 'Playfair Display, serif'
          }}>
          ...
          <div className="grid md:grid-cols-3 gap-6 mb-12">
            ...
            impact: "€800 tour → €760 to you"
          }].map(item => <Card key={item.title} className="p-6 border-charcoal/10 bg-white hover:shadow-lg transition-shadow">
                ...
                <h3 className="text-xl text-charcoal mb-3" style={{
              fontFamily: 'Playfair Display, serif'
            }}>
                  {item.title}
                </h3>
          ...
          <div className="bg-charcoal text-white p-10 rounded-lg">
            <p className="text-2xl lg:text-3xl leading-relaxed italic text-cream" style={{
            fontFamily: 'Playfair Display, serif'
          }}>
      ...
      <section className="min-h-screen bg-charcoal text-white py-16 px-8 lg:px-16 flex items-center print:page-break-after">
        <div className="max-w-6xl mx-auto w-full">
          <div className="mb-10">
            ...
            <h2 className="text-4xl lg:text-6xl text-white mb-6 text-center" style={{
            fontFamily: 'Playfair Display, serif'
          }}>
          ...
          <div className="bg-white rounded-lg shadow-2xl overflow-hidden">
            ...
            <div className="p-8">
              ...
              <div className="grid grid-cols-4 gap-4 mb-8">
                ...
                value: "4.9★",
                icon: Star
              }].map(stat => <div key={stat.label} className="bg-cream p-5 rounded-lg border border-burgundy/10">
              ...
              <div className="mb-6">
                ...
                <div className="space-y-3">
                  {[{
                  tour: "Dolomites Via Ferrata",
                  client: "Anna K.",
                  date: "Jun 15-18",
                  status: "Confirmed",
                  amount: "€680"
                }, {
                  tour: "Scottish Highlands Trek",
                  client: "James M.",
                  date: "Jun 22-24",
                  status: "Waiver Pending",
                  amount: "€450"
                }, {
                  tour: "Pyrenees High Route",
                  client: "Sophie L.",
                  date: "Jul 2-6",
                  status: "Confirmed",
                  amount: "€750"
                }].map((booking, idx) => <div key={idx} className="flex items-center gap-4 p-4 bg-cream/50 rounded-lg border border-burgundy/10">
                      ...
                      <div className="text-sm text-burgundy w-20 text-right" style={{
                    fontFamily: 'Playfair Display, serif'
                  }}>{booking.amount}</div>
                    </div>)}
                </div>
              ...
              <div className="grid grid-cols-5 gap-3">
                ...
                icon: Star,
                label: "Reviews"
              }].map(action => <div key={action.label} className="bg-white border border-burgundy/10 p-4 rounded-lg text-center hover:bg-burgundy/5 transition-colors">
      ...
      <section className="min-h-screen flex flex-col lg:flex-row print:page-break-after">
        ...
        <div className="lg:w-1/2 bg-cream text-charcoal flex items-center justify-center p-8 lg:p-16">
          <div className="max-w-xl">
            ...
            <h2 className="text-4xl lg:text-5xl text-charcoal mb-6" style={{
            fontFamily: 'Playfair Display, serif'
          }}>
            ...
            <div className="space-y-4 mb-8">
              {["Automated email invites to all participants", "10-section comprehensive waiver form", "Medical history & emergency contacts", "Insurance verification with upload", "Real-time status tracking per booking", "Mobile-optimized signing experience"].map(item => <div key={item} className="flex items-start gap-3">
            ...
            <div className="bg-burgundy/10 border-l-4 border-burgundy p-6 rounded-r">
              <div className="flex items-start gap-4">
                ...
                <div>
                  <h4 className="text-lg text-charcoal mb-2" style={{
                  fontFamily: 'Playfair Display, serif'
                }}>
            ...
            <div className="bg-white rounded-lg shadow-2xl border border-charcoal/10 overflow-hidden">
              ...
              <div className="p-6">
                <div className="space-y-3 mb-6">
                  ...
                  email: "tom@email.com",
                  statusColor: "red"
                }].map((participant, idx) => <div key={idx} className="flex items-center gap-4 p-4 bg-cream/50 rounded-lg border border-burgundy/10">
                      <div className="flex-1">
                        <div className="text-charcoal mb-1">{participant.name}</div>
                        <div className="text-sm text-charcoal/60">{participant.email}</div>
                      </div>
                      <Badge className={`text-xs ${participant.statusColor === "green" ? "bg-green-100 text-green-700" : participant.statusColor === "amber" ? "bg-amber-100 text-amber-700" : "bg-red-100 text-red-700"} border-0`}>
                        {participant.status}
                      </Badge>
                    </div>)}
                </div>
                ...
                <div className="mb-6 pt-6 border-t border-charcoal/10">
                  <div className="flex items-center justify-between text-sm mb-3">
                    ...
                    <span className="text-burgundy" style={{
                    fontFamily: 'Playfair Display, serif'
                  }}>50% (2/4)</span>
                  </div>
                  <div className="w-full bg-charcoal/10 rounded-full h-3">
                    <div className="bg-burgundy h-3 rounded-full" style={{
                    width: '50%'
                  }}></div>
                  </div>
                </div>
          ...
          <div className="grid md:grid-cols-2 gap-12">
            ...
            <div>
              ...
              <Card className="p-6 border-charcoal/10 bg-white mb-8 shadow-lg">
                <div className="flex gap-4 mb-6">
                  ...
                  <div className="flex-1">
                    <h3 className="text-2xl text-charcoal mb-2" style={{
                    fontFamily: 'Playfair Display, serif'
                  }}>
                      Marco Albertini
                    </h3>
                ...
                <div className="grid grid-cols-3 gap-4">
                  <div>
                    <div className="text-xl text-burgundy" style={{
                    fontFamily: 'Playfair Display, serif'
                  }}>127</div>
              ...
              <div className="space-y-3">
                ...
                {["Personal Info & Bio", "Certifications & Badges", "Specialties & Skills", "Languages Spoken", "Tour Listings", "Pricing & Availability", "Insurance & Documents"].map((section, idx) => <div key={idx} className="flex items-center gap-3 p-3 bg-white rounded-lg border border-charcoal/10">
            ...
            <div>
              ...
              <div className="grid grid-cols-2 gap-4 mb-8">
                {[{
                name: "IFMGA Certified",
                desc: "International Guide",
                icon: Award
              }, {
                name: "UIMLA Verified",
                desc: "Mountain Leader",
                icon: Award
              }, {
                name: "First Aid Cert",
                desc: "Wilderness First Responder",
                icon: Heart
              }, {
                name: "Avalanche Level 3",
                ...
                name: "Leave No Trace",
                desc: "Environmental Steward",
                icon: Leaf
              }].map(badge => <Card key={badge.name} className="p-5 border-burgundy/10 bg-white hover:shadow-md transition-shadow">
                    <div className="w-12 h-12 bg-burgundy/10 rounded-full flex items-center justify-center mb-4">
                      <badge.icon className="w-6 h-6 text-burgundy" />
                    </div>
                    <h4 className="text-sm text-charcoal mb-1" style={{
                  fontFamily: 'Playfair Display, serif'
                }}>
                      {badge.name}
                    </h4>
              ...
              <div className="bg-charcoal text-white p-6 rounded-lg">
                <h4 className="text-lg mb-3 flex items-center gap-2" style={{
                fontFamily: 'Playfair Display, serif'
              }}>
        ...
        <div className="max-w-6xl mx-auto w-full">
          <div className="grid md:grid-cols-2 gap-12">
            ...
            <div>
              ...
              <h2 className="text-4xl lg:text-5xl text-white mb-6" style={{
              fontFamily: 'Playfair Display, serif'
            }}>
                95% Revenue Share
              </h2>
              ...
              <div className="bg-white rounded-lg overflow-hidden mb-8">
                ...
                <div className="p-6">
                  <div className="space-y-4">
                    ...
                    fee: "€240",
                    highlight: false
                  }].map((row, idx) => <div key={idx} className={`flex items-center justify-between p-4 rounded-lg ${row.highlight ? 'bg-burgundy/10 border-2 border-burgundy' : 'bg-cream/50'}`}>
                        <div className="flex-1">
                          <div className={`${row.highlight ? 'text-charcoal' : 'text-charcoal/70'}`} style={{
                        fontFamily: 'Playfair Display, serif'
                      }}>
                            {row.platform}
                          </div>
                        ...
                        <div className="text-right">
                          <div className={`text-2xl ${row.highlight ? 'text-burgundy' : 'text-charcoal/70'}`} style={{
                        fontFamily: 'Playfair Display, serif'
                      }}>
                            {row.you}
                          </div>
                  ...
                  <div className="mt-6 pt-6 border-t border-charcoal/10 bg-burgundy/5 -mx-6 -mb-6 px-6 py-5">
                    <div className="flex items-center justify-between">
                      ...
                      <span className="text-2xl text-burgundy" style={{
                      fontFamily: 'Playfair Display, serif'
                    }}>
                        €120 - €200
                      </span>
              ...
              <div className="bg-burgundy/20 border border-burgundy-light/30 text-white p-6 rounded-lg">
                <h4 className="text-lg mb-2 flex items-center gap-2" style={{
                fontFamily: 'Playfair Display, serif'
              }}>
            ...
            <div>
              ...
              <Card className="p-6 border-burgundy/10 bg-cream mb-8">
                <h3 className="text-lg text-charcoal mb-6 flex items-center gap-2" style={{
                fontFamily: 'Playfair Display, serif'
              }}>
                ...
                <div className="grid grid-cols-2 gap-4 mb-6">
                  <div className="bg-white p-5 rounded-lg border border-burgundy/10">
                    <div className="text-3xl text-burgundy mb-2" style={{
                    fontFamily: 'Playfair Display, serif'
                  }}>
                      €250
                    </div>
                ...
                <div className="space-y-3 mb-6">
                  ...
                  earned: "€0"
                }].map((ref, idx) => <div key={idx} className="flex items-center justify-between p-3 bg-white rounded-lg border border-burgundy/10">
                      ...
                      <div className="flex items-center gap-3">
                        ...
                        <span className="text-burgundy w-12 text-right" style={{
                      fontFamily: 'Playfair Display, serif'
                    }}>{ref.earned}</span>
                      </div>
                    </div>)}
              ...
              <div className="grid grid-cols-2 gap-4">
                <div className="bg-white/10 border border-white/20 p-6 rounded-lg text-center">
                  <div className="text-3xl text-burgundy-light mb-2" style={{
                  fontFamily: 'Playfair Display, serif'
                }}>€50</div>
        ...
        <div className="max-w-6xl mx-auto w-full">
          <div className="grid md:grid-cols-2 gap-12">
            ...
            <div>
              ...
              }].map(pillar => <Card key={pillar.title} className="p-6 border-charcoal/10 bg-white hover:shadow-lg transition-shadow">
                    <div className="flex items-start gap-4">
                      ...
                      fontFamily: 'Playfair Display, serif'
                        ...
                        <ul className="space-y-2">
                          {pillar.points.map(point => <li key={point} className="flex items-center gap-2 text-sm text-charcoal/70">
              ...
              <div className="bg-charcoal text-white p-8 rounded-lg">
                <p className="text-xl lg:text-2xl italic leading-relaxed text-cream" style={{
                fontFamily: 'Playfair Display, serif'
              }}>
            ...
            <div>
              ...
              <div className="space-y-4 mb-8">
                ...
                badge: "Exposure"
              }].map(benefit => <Card key={benefit.title} className="p-5 border-charcoal/10 bg-white hover:shadow-md transition-shadow">
                    <div className="flex items-start gap-4">
                      <div className="w-12 h-12 bg-burgundy/10 rounded-full flex items-center justify-center flex-shrink-0">
                        <benefit.icon className="w-6 h-6 text-burgundy" />
                      </div>
                      <div className="flex-1">
                        <h4 className="text-base text-charcoal mb-1" style={{
                      fontFamily: 'Playfair Display, serif'
                    }}>
                          {benefit.title}
                        </h4>
      ...
      <section className="min-h-screen bg-charcoal text-white py-16 px-8 lg:px-16 flex items-center print:page-break-after">
        <div className="max-w-5xl mx-auto w-full">
          ...
          <div className="space-y-5">
            ...
            duration: "Ongoing"
          }].map(phase => <div key={phase.step} className="flex gap-5 items-start">
      ...
      <section className="min-h-screen flex flex-col lg:flex-row">
        {/* Left: Image with contour overlay */}
        <div className="lg:w-1/2 h-[50vh] lg:h-screen relative overflow-hidden">
          <SmartImage category="hero" tags={["Pyrenees", "hiking", "mountain"]} alt="Mountain guide leading group through the Pyrenees" className="w-full h-full object-cover" priority="high" />
        ...
        <div className="lg:w-1/2 bg-burgundy text-white flex items-center justify-center p-8 lg:p-16">
          <div className="max-w-xl">
            <h2 className="text-5xl lg:text-6xl text-white mb-8 leading-tight" style={{
            fontFamily: 'Playfair Display, serif'
          }}>
            ...
            <div className="flex flex-col gap-4 mb-10">
              <Button onClick={() => navigate('/guide/signup')} className="bg-white hover:bg-cream text-burgundy px-10 py-6 text-lg">
                Sign Up as Guide
              </Button>
              <Button variant="outline" onClick={() => navigate('/contact')} className="border-2 border-burgundy text-burgundy bg-white hover:bg-cream px-10 py-6 text-lg">
