        ...
        <section className="min-h-screen flex flex-col lg:flex-row pt-16">
          ...
          <div className="lg:w-1/2 bg-charcoal text-white flex items-center justify-center p-8 lg:p-20 relative overflow-hidden">
            ...
            <div className="max-w-xl w-full relative z-10">
              ...
              {!submitted && (
                <div className="space-y-6">
                  ...
                  <div className="space-y-4">
                    <button
                      onClick={() => setUserType("hiker")}
                      className={`w-full group text-left p-6 border transition-all duration-300 ${
                        userType === "hiker"
                          ? "border-burgundy bg-burgundy/5"
                          : "border-white/10 hover:border-burgundy/50"
                      }`}
                    >
                      <div className="flex items-center justify-between">
                        <div className="flex items-center gap-4">
                          <Users className={`w-6 h-6 transition-colors ${
                            userType === "hiker" ? "text-burgundy-light" : "text-cream/40 group-hover:text-burgundy-light"
                          }`} />
                          <div>
                            <div className={`text-lg transition-colors font-playfair ${
                              userType === "hiker" ? "text-white" : "text-cream/80 group-hover:text-white"
                            }`}>
                              I'm a Hiker
                            </div>
                        ...
                        <ArrowRight className={`w-5 h-5 transition-all ${
                          userType === "hiker" ? "text-burgundy-light translate-x-0" : "text-cream/20 -translate-x-2 group-hover:translate-x-0 group-hover:text-burgundy-light"
                        }`} />
                      </div>
                    </button>
                      ...
                      <div className="flex items-center justify-between">
                        <div className="flex items-center gap-4">
                          <Mountain className={`w-6 h-6 transition-colors ${
                            userType === "guide" ? "text-burgundy-light" : "text-cream/40 group-hover:text-burgundy-light"
                          }`} />
                          <div>
                            <div className={`text-lg transition-colors font-playfair ${
                              userType === "guide" ? "text-white" : "text-cream/80 group-hover:text-white"
                            }`}>
                              I'm a Guide
                            </div>
                        ...
                        <ArrowRight className={`w-5 h-5 transition-all ${
                          userType === "guide" ? "text-burgundy-light translate-x-0" : "text-cream/20 -translate-x-2 group-hover:translate-x-0 group-hover:text-burgundy-light"
                        }`} />
                      </div>
                    </button>
                  </div>
              ...
              {/* Success State */}
              {submitted && (
                <div className="border border-burgundy/30 p-8 animate-in fade-in slide-in-from-bottom-4 duration-500">
                  ...
                  <p className="text-cream/70 mb-8 leading-relaxed">
                    {userType === "hiker" 
                      ? "We'll email you as soon as we launch. Get ready to explore Europe's Alps with certified guides."
                      : "We'll review your application and reach out within 48 hours. Excited to have you join us."}
                  </p>
                  <Button
                    variant="outline"
                    onClick={() => {
        ...
        <section className="py-0 bg-charcoal">
          <div className="grid md:grid-cols-3">
            {[
              ...
              <div key={region.name} className="group relative h-[500px] overflow-hidden">
                <SmartImage
                  category="landscape"
                  usageContext="landing"
                  tags={region.tags}
                  alt={`${region.name} mountain landscape`}
          ...
          <div className="max-w-7xl mx-auto px-6 relative z-10">
            ...
            <div className="grid lg:grid-cols-3 gap-8 mb-16">
              {[
                ...
                <Card key={benefit.title} className="p-10 bg-white/10 border-white/20 backdrop-blur-md hover:bg-white/15 transition-all hover:shadow-2xl hover:shadow-white/10">
              ...
              <div className="grid md:grid-cols-2 gap-12 text-left max-w-4xl mx-auto">
                <div>
                  ...
                  <ul className="space-y-4">
                    {[
                      "0% commission for 6 months testing",
                      "2% lifetime rate forever (vs. 5% standard)",
                      "Featured guide status on launch day",
                      "Shape platform features & policies",
                      "1-on-1 onboarding support",
                      "Co-marketing in launch campaigns"
                    ].map((item) => (
              ...
              <div className="grid md:grid-cols-2 gap-12 items-start">
                ...
                <div className="space-y-6">
                  ...
                  <div className="grid grid-cols-3 gap-4 pt-4">
                    {['Guide-first platform', 'Authentic experiences', 'Built on trust'].map((item, idx) => (
