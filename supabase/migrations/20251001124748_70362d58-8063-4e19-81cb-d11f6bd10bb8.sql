-- Update handle_new_user trigger to auto-request verification for guides with certifications
...
BEGIN
  ...
  BEGIN
    ...
    IF user_role = 'guide' THEN
      -- Check if guide has Priority 1 or 2 certifications (simplified check)
      -- In practice, certifications are added after user creation, so this is a placeholder
