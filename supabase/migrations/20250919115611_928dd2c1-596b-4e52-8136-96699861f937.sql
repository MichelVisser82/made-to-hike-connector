...
DROP POLICY IF EXISTS "Guides can view their own tours" ON public.tours;
...
DROP POLICY IF EXISTS "Guides can update their own tours" ON public.tours;
DROP POLICY IF EXISTS "Admins can update all tours" ON public.tours;
DROP POLICY IF EXISTS "Guides can delete their own tours" ON public.tours;
DROP POLICY IF EXISTS "Admins can delete all tours" ON public.tours;

DROP POLICY IF EXISTS "Users can view their own bookings as hiker" ON public.bookings;
DROP POLICY IF EXISTS "Guides can view bookings for their tours" ON public.bookings;
DROP POLICY IF EXISTS "Admins can view all bookings" ON public.bookings;
DROP POLICY IF EXISTS "Hikers can create bookings" ON public.bookings;
DROP POLICY IF EXISTS "Hikers can update their own bookings" ON public.bookings;
DROP POLICY IF EXISTS "Guides can update bookings for their tours" ON public.bookings;
DROP POLICY IF EXISTS "Admins can update all bookings" ON public.bookings;

DROP POLICY IF EXISTS "Anyone can view reviews" ON public.reviews;
DROP POLICY IF EXISTS "Hikers can create reviews for their bookings" ON public.reviews;
DROP POLICY IF EXISTS "Hikers can update their own reviews" ON public.reviews;
