...
export function GuideSignupFlow() {
  ...
  const renderStep = () => {
    switch (signup.currentStep) {
      ...
      case 9: return <Step11GuidingAreas data={signup.formData} updateData={signup.updateFormData} onNext={signup.nextStep} onBack={signup.previousStep} />;
      case 10: return <Step12TerrainCapabilities data={signup.formData} updateData={signup.updateFormData} onNext={signup.nextStep} onBack={signup.previousStep} />;
      case 11: return <Step13Bio data={signup.formData} updateData={signup.updateFormData} onNext={signup.nextStep} onBack={signup.previousStep} />;
      case 12: return <Step14Preview data={signup.formData} onNext={signup.nextStep} onBack={signup.previousStep} />;
      case 13: return <Step15Terms data={signup.formData} updateData={signup.updateFormData} onSubmit={signup.submitSignup} onBack={signup.previousStep} isSubmitting={signup.isSubmitting} />;
      ...
      <div className="sticky top-0 z-50 bg-white border-b shadow-sm">
        <div className="container mx-auto px-4 py-4">
          <div className="flex items-center gap-4 mb-2">
            <span className="text-sm font-medium text-charcoal">Step {signup.currentStep} of 14</span>
