...
export function Step06Certifications({ data, updateData, onNext, onBack }: Step06CertificationsProps) {
  ...
  const hasPriority1or2 = certifications.some(
    cert => cert.verificationPriority === 1 || cert.verificationPriority === 2
  );
      ...
      <Card>
        <CardHeader>
          ...
          <p className="text-muted-foreground">
            Add your professional qualifications. At least one Priority 1 or 2 certification is required for verified guide status.
          </p>
        </CardHeader>
        <CardContent className="space-y-6">
              ...
              <CardContent className="p-4 pr-12">
                <div className="flex items-start gap-3">
                  <div 
                    ...
                    style={{ backgroundColor: cert.badgeColor || '#6b7280' }}
                  >
                    {cert.verificationPriority === 1 ? (
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    {cert.verificationPriority && (
                      <div className="text-xs text-muted-foreground mt-1">
                        Priority {cert.verificationPriority} - {
                          cert.verificationPriority === 1 ? '2 hour verification' :
                          cert.verificationPriority === 2 ? '24 hour verification' :
                          '3-5 business days'
                        }
                      </div>
                    )}
                ...
                {!cert.isPrimary && certifications.length > 1 && (
                  <Button
                    variant="outline"
                    size="sm"
                    className="mt-3"
                      ...
                      <Alert>
                        ...
                        <AlertDescription>
                          <div className="text-sm">
                            ...
                            <strong>Verification:</strong> Priority {newCert.verificationPriority} - {
                              findCertificationById(selectedCertId)?.verificationTarget
                            }
                          </div>
                        </AlertDescription>
                      </Alert>
                  ...
                  <>
                    <div>
                      ...
                      <Input
                        ...
                        className={certNumberError ? 'border-destructive' : ''}
                      />
                      {certNumberError && (
                        <p className="text-sm text-destructive mt-1">{certNumberError}</p>
                      )}
                    </div>
                    ...
                    <div>
                      ...
                      <div className="mt-1">
                        ...
                        />
                        {newCert.certificateDocument && typeof newCert.certificateDocument !== 'string' && (
          ...
          {certifications.length > 0 && !hasPriority1or2 && (
            <Alert>
              <AlertCircle className="h-4 w-4" />
              <AlertDescription>
