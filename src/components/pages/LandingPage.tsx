    ...
    <div className="min-h-screen">
      ...
      <section className="relative h-screen">
        ...
        <div className="relative container mx-auto px-4 h-full flex items-center justify-center">
          <div className="max-w-4xl mx-auto text-center text-white">
            <h1 className="text-5xl md:text-6xl font-serif text-white mb-6 leading-tight" style={{
            ...
            <Button size="lg" onClick={() => onNavigateToSearch()} className="text-lg px-8 py-6 h-auto bg-burgundy hover:bg-burgundy/90 text-white">
            ...
            <div className="relative mt-12">
              <div className="absolute inset-0 rounded-2xl overflow-hidden">
                <SmartImage category="statistics" usageContext="trust_indicators" tags={['hikers', 'group', 'celebration', 'success']} className="w-full h-full object-cover opacity-20" alt="Group of successful hikers celebrating their mountain adventure" />
      ...
      <section className="py-20 relative">
        <div className="absolute inset-0">
          <SmartImage category="guide" usageContext="teaching" tags={['guide', 'mountain', 'expert', 'teaching']} className="w-full h-full object-cover" alt="Professional mountain guide teaching hiking techniques to a group" />
          <div className="absolute inset-0 bg-gradient-to-b from-black/40 via-black/15 to-transparent" />
          <div className="absolute bottom-0 left-0 right-0 h-24 bg-gradient-to-b from-transparent to-cream-light" />
        </div>
        <div className="relative container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center text-white">
            <h2 className="text-4xl md:text-5xl font-serif text-white mb-4" style={{
            fontFamily: 'Playfair Display, serif'
          }}>Share Your Mountain Expertise</h2>
      ...
      <section className="py-20 bg-muted/30">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            <h2 className="text-4xl md:text-5xl font-serif mb-4" style={{
            fontFamily: 'Playfair Display, serif'
          }}>Hand-Selected & Verified Guides</h2>
      ...
      <section className="py-20 bg-burgundy">
        <div className="container mx-auto px-4">
          <div className="text-center">
            <h2 className="text-4xl md:text-5xl font-serif mb-8 text-white" style={{
            fontFamily: 'Playfair Display, serif'
          }}>Discover our community of Guides</h2>
            <Button size="lg" onClick={() => navigate('/guides')} className="bg-white text-burgundy hover:bg-white/90 font-semibold">
              Browse Guides
            </Button>
          </div>
        </div>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-6xl mx-auto">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
              {/* Certifications */}
              <div>
                <h3 className="text-2xl md:text-3xl font-serif mb-8" style={{
                fontFamily: 'Playfair Display, serif'
              }}>Recognised Certifications</h3>
                <div className="space-y-4">
      ...
      <section className="py-20 bg-muted/30">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            <h2 className="text-4xl md:text-5xl font-serif mb-4" style={{
            fontFamily: 'Playfair Display, serif'
          }}>What Our Hikers Say</h2>
            <p className="text-lg text-muted-foreground">Real experiences from real adventurers</p>
          </div>

          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 max-w-6xl mx-auto">
            <Card className="relative overflow-hidden">
              <SmartImage category="hiker" usageContext="testimonial" tags={['hiker', 'portrait', 'happy', 'dolomites']} className="w-full h-48 object-cover" alt="Happy female hiker Sarah enjoying her Dolomites adventure" />
              <div className="p-6">
            ...
            <Card className="relative overflow-hidden">
              <SmartImage category="hiker" usageContext="testimonial" tags={['hiker', 'portrait', 'male', 'scotland']} className="w-full h-48 object-cover" alt="Satisfied male hiker James after his Scottish Highlands tour" />
              <div className="p-6">
                <div className="flex items-center gap-1 mb-4">
                  {[1, 2, 3, 4, 5].map(star => <Star key={star} className="h-4 w-4 text-yellow-500 fill-current" />)}
                </div>
            ...
            <Card className="relative overflow-hidden">
              <SmartImage category="hiker" usageContext="testimonial" tags={['hiker', 'portrait', 'group', 'pyrenees']} className="w-full h-48 object-cover" alt="Group of hikers celebrating their successful Pyrenees expedition" />
              <div className="p-6">
                <div className="flex items-center gap-1 mb-4">
                  {[1, 2, 3, 4, 5].map(star => <Star key={star} className="h-4 w-4 text-yellow-500 fill-current" />)}
                </div>
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 max-w-6xl mx-auto">
            <div className="relative aspect-[4/5] rounded-xl overflow-hidden group cursor-pointer">
              <SmartImage category="landscape" usageContext="hero" tags={['dolomites', 'limestone', 'peaks', 'alpine', 'dramatic']} className="w-full h-full object-cover group-hover:scale-105 transition-transform duration-500" fallbackSrc="" alt="Dramatic Dolomites Tre Cime peaks rising above sea of clouds at sunrise" priority="medium" />
            ...
            <div className="relative aspect-[4/5] rounded-xl overflow-hidden group cursor-pointer">
              <SmartImage category="hero" usageContext="tours" tags={['highland', 'trail', 'moorland', 'stream', 'backpacking', 'wilderness']} className="w-full h-full object-cover group-hover:scale-105 transition-transform duration-500" fallbackSrc="" alt="Highland adventure trail with panoramic mountain views in Scotland" priority="medium" />
              <div className="absolute inset-0 bg-gradient-to-t from-black/70 via-transparent to-transparent" />
              <div className="absolute bottom-6 left-6 text-white">
            ...
            <div className="relative aspect-[4/5] rounded-xl overflow-hidden group cursor-pointer">
              <SmartImage category="mountains" usageContext="background" tags={['alpine', 'meadow', 'wilderness', 'peaks', 'panorama']} className="w-full h-full object-cover group-hover:scale-105 transition-transform duration-500" fallbackSrc="" alt="Pristine alpine meadows with wildflowers beneath mountain peaks" priority="medium" />
              <div className="absolute inset-0 bg-gradient-to-t from-black/70 via-transparent to-transparent" />
              <div className="absolute bottom-6 left-6 text-white">
      ...
      <section className="py-20 bg-burgundy text-white">
        <div className="container mx-auto px-4 text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Button size="lg" variant="secondary" onClick={() => onNavigateToSearch()} className="bg-white text-burgundy hover:bg-white/90 font-semibold">
              Browse All Tours
            </Button>
            {!user && <Button size="lg" variant="outline" onClick={() => navigate('/guide/signup')} className="border-white text-white hover:bg-white hover:text-burgundy">
                Become a Guide
              </Button>}
          </div>
        </div>
