            ...
            <div>
              ...
              <div className="space-y-3">
                ...
                <Card className="p-4 bg-white border-burgundy/10">
                  ...
                  <p className="text-sm text-charcoal/70">You'll only receive your reward once the referral completes their first paid tour. If they sign up but don't book, the referral will remain pending. You can send them a reminder through the platform to encourage them to book!</p>
                </Card>
              </div>
            </div>
